...
export function saveOfflineListing(listing: Partial<OfflineListing> & { id?: string; title?: string }): OfflineListing {
  ...
  if (existingIdx >= 0) {
    ...
    const updated: OfflineListing = {
      ...
      secondaryPhone: listing.secondaryPhone !== undefined ? listing.secondaryPhone : existing.secondaryPhone,
      ...
      logo: listing.logo || existing.logo,
      gallery: listing.gallery || existing.gallery,
  ...
  const newListing: OfflineListing = {
    ...
    secondaryPhone: listing.secondaryPhone || null,
