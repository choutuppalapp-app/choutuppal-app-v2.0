...
import { sendTemplateMessage } from '@/lib/wacrm/whatsapp/meta-api';
import { decrypt } from '@/lib/wacrm/whatsapp/encryption';
import {
...
import { resolveTemplateRow } from '@/lib/wacrm/whatsapp/template-body';
import type { MessageTemplate } from '@/types/wacrm';
import { findOrCreateContact } from '@/lib/wacrm/api/v1/contacts';
