...
import {
  ...
  sendInteractiveList,
  type MediaKind,
} from '@/lib/wacrm/whatsapp/meta-api';
import {
  validateInteractivePayload,
  interactivePayloadPreviewText,
  type InteractiveMessagePayload,
} from '@/lib/wacrm/whatsapp/interactive';
import { decrypt, encrypt, isLegacyFormat } from '@/lib/wacrm/whatsapp/encryption';
...
} from '@/lib/wacrm/whatsapp/phone-utils';
import type { MessageTemplate } from '@/types/wacrm';
import {
  resolveTemplateRow,
  templateBodyParams,
  templateContentText,
} from '@/lib/wacrm/whatsapp/template-body';
