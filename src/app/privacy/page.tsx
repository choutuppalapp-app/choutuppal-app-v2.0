        ...
        <div className="rounded-3xl glass p-8">
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-slate-600">
            ...
            <section>
              ...
              <p className="mt-1">You can delete your listings, stories, and community posts at any time. Account deletion requests can be sent to 9494348175.</p>
            </section>
            <section>
              <h2 className="font-bold text-slate-900">7. Contact</h2>
              <p className="mt-1">For privacy concerns, contact: Choutuppal, Yadadri, Telangana - 508252. Phone: 9494348175.</p>
            </section>
          </div>
