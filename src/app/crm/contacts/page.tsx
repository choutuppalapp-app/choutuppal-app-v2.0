...
import type { Contact, Tag, ContactTag } from '@/types/wacrm';
import { Button } from '@/components/wacrm/ui/button';
import { Input } from '@/components/wacrm/ui/input';
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from '@/components/wacrm/ui/table';
import { Checkbox } from '@/components/wacrm/ui/checkbox';
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
} from '@/components/wacrm/ui/dropdown-menu';
import {
  Dialog,
  DialogContent,
  DialogHeader,
  ...
  DialogDescription,
  DialogFooter,
} from '@/components/wacrm/ui/dialog';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@/components/wacrm/ui/popover';
import {
  Search,
  Plus,
  Upload,
...
import { ContactForm } from '@/components/wacrm/contacts/contact-form';
import { ContactDetailView } from '@/components/wacrm/contacts/contact-detail-view';
import { ImportModal } from '@/components/wacrm/contacts/import-modal';
import { CustomFieldsManager } from '@/components/wacrm/contacts/custom-fields-manager';
import { useCan } from '@/hooks/wacrm/use-can';
import { GatedButton } from '@/components/wacrm/ui/gated-button';
...
export default function ContactsPage() {
  ...
  const fetchContacts = useCallback(async () => {
    ...
    if (selectedTagIds.length > 0) {
      ...
      const data = await getContacts(); const error = null;
  ...
  async function handleBulkDelete() {
    ...
    for(const id of ids) await deleteContact(id); const error = null;
