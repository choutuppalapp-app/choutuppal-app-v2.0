...
import { addContactTag, deleteContactTag } from '@/lib/wacrm/contacts/tag-api';
import { useAuth } from '@/hooks/wacrm/use-auth';
import { formatCurrency } from '@/lib/wacrm/currency';
import { toast } from 'sonner';
import type { Contact, Tag, ContactTag, ContactNote, CustomField, ContactCustomValue, Deal, MessageTemplate } from '@/types/wacrm';
import {
  TemplatePicker,
  type TemplateSendValues,
} from '@/components/wacrm/inbox/template-picker';
import {
  Sheet,
  SheetContent,
  SheetHeader,
  SheetTitle,
  SheetDescription,
} from '@/components/wacrm/ui/sheet';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/wacrm/ui/tabs';
import { Button } from '@/components/wacrm/ui/button';
import { Input } from '@/components/wacrm/ui/input';
import { Label } from '@/components/wacrm/ui/label';
import { Textarea } from '@/components/wacrm/ui/textarea';
import { Avatar, AvatarFallback } from '@/components/wacrm/ui/avatar';
import { Badge } from '@/components/wacrm/ui/badge';
import { ScrollArea } from '@/components/wacrm/ui/scroll-area';
import {
  Phone,
  Mail,
  Building2,
