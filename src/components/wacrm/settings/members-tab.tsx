...
import {
  ...
  AvatarFallback,
  AvatarImage,
} from '@/components/wacrm/ui/avatar';
import { Badge } from '@/components/wacrm/ui/badge';
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from '@/components/wacrm/ui/tooltip';
import { Button } from '@/components/wacrm/ui/button';
import { Card, CardContent } from '@/components/wacrm/ui/card';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { RequireRole } from '@/components/wacrm/auth/require-role';
import { useAuth } from '@/hooks/wacrm/use-auth';
import { usePresence } from '@/hooks/wacrm/use-presence';
import type { AccountRole } from '@/lib/wacrm/auth/roles';
import { presenceLabel, summarize } from '@/lib/wacrm/presence';
import {
  PRESENCE_DOT_CLASS,
  PresenceDot,
} from '@/components/wacrm/presence/presence-dot';
