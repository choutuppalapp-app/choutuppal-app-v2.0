...
import { canEditSettings } from '@/lib/wacrm/auth/roles';
...
import { Switch } from '@/components/wacrm/ui/switch';
import {
  Card,
  CardContent,
  CardHeader,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/components/wacrm/ui/select';
import { SettingsPanelHead } from './settings-panel-head';
import { AiKnowledgeCard } from './ai-knowledge';
import { AI_PROVIDER_DEFAULT_MODEL } from '@/lib/wacrm/ai/defaults';
import type { AiProvider } from '@/lib/wacrm/ai/types';
import type { AccountMember } from '@/types/wacrm';
import { fetchAccountMembers, memberLabel } from '@/lib/wacrm/account/members';
