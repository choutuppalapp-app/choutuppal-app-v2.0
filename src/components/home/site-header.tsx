    ...
    <header className="sticky top-0 z-50 bg-white shadow-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-4 lg:px-6">
        ...
        <Link href="/" className="flex shrink-0 items-center gap-2">
          {tenant.logoUrl ? (
            <Image width={64} height={64} sizes="64px" quality={75} src={tenant.logoUrl} alt={tenant.name} className="h-10 w-auto object-contain" loading="lazy" decoding="async" />
          ) : isDefault ? (
            <Image width={64} height={64} sizes="64px" quality={75} src="/logo.webp" alt="Choutuppal App" className="h-10 w-auto" loading="lazy" decoding="async" />
          ) : (
